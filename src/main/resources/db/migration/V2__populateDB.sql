...
VALUES ((SELECT id FROM users WHERE email = 'danil@yandex.com'), 'main', 'USD', 'CASH');

INSERT INTO transactions(user_id, date_time, amount, operation_kind, category)
VALUES ((SELECT id FROM users WHERE email = 'danil@yandex.com'),
        '2025-05-07 10:00:00', 460, 'EXPENSE', 'TRANSPORT');